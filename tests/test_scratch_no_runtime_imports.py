"""Guardião T-042: pasta scratch/ órfã sem callers runtime.

Ver auditoria scratch/ (16 auditorias por pasta, 2026-05-31) — scratch/
é área de rascunho/experimentos órfã (0 consumidores em produção).
Bloqueio de import-ban impede que código de runtime passe a depender de
material de rascunho até DHP-13 decidir destino final.
...
BANNED_MODULE_PREFIX = "scratch"
# Allowlist: auto-importação interna em scratch/ é OK (a pasta importa si)
...
def test_no_runtime_imports_of_scratch_package():
    offenders = []
    ...
    assert not offenders, (
        f"Imports proibidos da pasta orfã 'scratch/' em runtime "
